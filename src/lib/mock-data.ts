...
export const mockResponseTeams: ResponseTeam[] = [
  {
    ...
    members: [
      { id: 'M001', name: 'Roberto Guzman', role: 'Driver/Responder', availability: 'available' },
      { id: 'M002', name: 'Santiago Perez', role: 'Driver/Responder', availability: 'available' },
      { id: 'M003', name: 'Andres Bautista', role: 'Driver/Responder', availability: 'available' },
      { id: 'M004', name: 'Diego Castillo', role: 'Driver/Responder', availability: 'unavailable' },
    ],
  ...
  },
  {
    ...
    members: [
      { id: 'M005', name: 'Carmen Rivera', role: 'Driver/Responder', availability: 'available' },
      { id: 'M006', name: 'Teresa Flores', role: 'Driver/Responder', availability: 'available' },
      { id: 'M007', name: 'Ricardo Santos', role: 'Driver/Responder', availability: 'available' },
    ],
    availability: 'available',
  ...
  },
  {
    ...
    members: [
      { id: 'M008', name: 'Antonio Reyes', role: 'Driver/Responder', availability: 'available' },
      { id: 'M009', name: 'Mariano Lopez', role: 'Driver/Responder', availability: 'unavailable' },
      { id: 'M010', name: 'Francisco Diaz', role: 'Driver/Responder', availability: 'available' },
    ],
    availability: 'available',
  ...
  },
  {
    ...
    members: [
      { id: 'M011', name: 'Gregorio Magno', role: 'Driver/Responder', availability: 'unavailable' },
      { id: 'M012', name: 'Patricia Encarnacion', role: 'Driver/Responder', availability: 'unavailable' },
      { id: 'M013', name: 'Eduardo Villareal', role: 'Driver/Responder', availability: 'unavailable' },
      { id: 'M014', name: 'Luzviminda Torres', role: 'Driver/Responder', availability: 'unavailable' },
    ],
  ...
  },
  {
    ...
    members: [
      { id: 'M015', name: 'Ramon Espiritu', role: 'Driver/Responder', availability: 'available' },
      { id: 'M016', name: 'Danilo Magbanua', role: 'Driver/Responder', availability: 'available' },
      { id: 'M017', name: 'Jerry Aquino', role: 'Driver/Responder', availability: 'available' },
    ],
    availability: 'available',
